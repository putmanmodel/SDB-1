...
This checklist ensures that any implementation of SDB-1 has been validated across the core failure modes SDB-1 is meant to mitigate. It does not certify safety; it documents due diligence.

⸻

1. Disagreement Detection Tests
...
4. Reversible Action Validation
